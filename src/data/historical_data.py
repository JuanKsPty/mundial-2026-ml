"""Download and normalize historical data: martj42 results + FIFA rankings."""
...
from src.data.achievements import build_canonical_achievements, canon_team
from src.utils.cache import cache_age_days, is_cache_fresh
...
def load_and_normalize_results() -> pd.DataFrame:
    ...
    # martj42 ships upcoming WC2026 fixtures with NaN scores; without this
    # filter they would be silently treated as draws downstream (NaN > NaN
    # is False both ways) and corrupt Elo/form/h2h.
