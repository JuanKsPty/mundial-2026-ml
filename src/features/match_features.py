# Walk-forward construction (pre-match state only, no leakage): Elo with
# k=32 competitive / k=16 friendly, last-5 form, head-to-head and
# penalty-shootout rates. home_score/away_score columns double as targets
# for the Poisson model.

"""Walk-forward match features (Elo, form, h2h) + team strength table."""
...
from src.data.historical_data import get_tournament_categories, load_and_normalize_results
